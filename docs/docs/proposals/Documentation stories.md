...
![[assets/287413119-875e3533-81a8-4f7f-9862-db6668f7c93f.png]]
...
Check out [[Documentation stories]] for examples.
...
| Pros                | - Components can be inlined with prose<br>- Write docs in React, Fusion, plain GuiObjects, or anything else                                                                            | - Prose written in Markdown so extra components for writing prose are not needed                              | - Existing standard                                                          |
| **Cons**            | - New standard<br>- Need to include a package for users to write prose<br>- For supported formats (React, Roact, Fusion, GuiObjects) a separate addon is needed and must be maintained | - New standard<br>- Roblox users might not know how to write Markdown                                         | - Can’t render components inline<br>- Need to port extractor to Luau         |
| **Chosen solution** |                                                                                                                                                                                        |                                                                                                               |                                                                              |
...
- [ ] [Marin Minnerly](mailto:me@vocksel.com) Read up on Storybook’s [Docs section](https://storybook.js.org/docs/writing-docs)
