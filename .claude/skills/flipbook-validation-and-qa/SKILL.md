...
- **ContextProvider errors:** Known FIXME at `createFlipbookApp.luau:43` — if a ContextProvider throws, tests do not fail (React error boundaries capture it; the test sees an empty tree and passes). This is a gap; a manual smoke-test is required (see "Honest Fallback" below).
...
**Known Gap:** `createFlipbookApp.luau:43`
