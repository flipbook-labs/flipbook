--!strict
local networkingChatTypes = require(script.Parent.networkingChatTypes)
...
return function(config: networkingChatTypes.Config): networkingChatTypes.RequestThunks
	return {
