...
local flowtypes = require(script.Parent.Parent:WaitForChild('shared'))
...
local getInstance = require(script.Parent.Parent:WaitForChild('shared')).ReactInstanceMap.get
