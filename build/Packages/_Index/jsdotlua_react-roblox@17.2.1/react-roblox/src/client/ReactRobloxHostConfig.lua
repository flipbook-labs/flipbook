...
local ReactFeatureFlags = require(script.Parent.Parent.Parent:WaitForChild('shared')).ReactFeatureFlags
...
Object.assign(
	exports,
	require(script.Parent.Parent.Parent:WaitForChild('shared')).ReactFiberHostConfig.WithNoPersistence
)
